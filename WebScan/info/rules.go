...
var RuleDatas = []RuleData{
	...
	{"致远OA", "code", "(/seeyon/Configs/|/seeyon/USER-DATA/IMAGES/LOGIN/login.gif)"},
	...
	{"万户oa", "code", "(/defaultroot/templates/template_system/Configs/css/|/defaultroot/scripts/|css/css_whir.css)"},
	{"Spark_Master", "code", "(Spark Master at)"},
	{"华为_HUAWEI_SRG2220", "code", "(HUAWEI SRG2220)"},
	{"蓝凌OA", "code", "(/scripts/jquery.landray.Configs.js)"},
	...
	{"coremail", "code", "(/coremail/bundle/|contextRoot: \"/coremail\"|coremail/Configs)"},
	...
	{"致远OA", "code", "(/seeyon/USER-DATA/IMAGES/LOGIN/login.gif|/seeyon/Configs/)"},
	{"蓝凌EIS智慧协同平台", "code", "(/scripts/jquery.landray.Configs.js)"},
	...
	{"JEECMS", "code", "(/r/cms/www/red/js/Configs.js|/r/cms/www/red/js/indexshow.js|Powered by JEECMS|JEECMS|/jeeadmin/jeecms/index.do)"},
